...
function isSelect(selectSquare) {
    ...
    if (flag === 'A') {
        ...
        // Computer (bear) takes turn after 2 seconds
        setTimeout(function() {
            bearTurn();
        }, 2000);
    }
