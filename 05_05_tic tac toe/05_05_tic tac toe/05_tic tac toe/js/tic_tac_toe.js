...
console.log("newgamebtn_display:", newgamebtn_display);
...
const msgtext3 = '<p class="image"><img src="img/penguins.jpg" width="61px" height="61px"/></p><p class="text">Penguins Win!</p>';
const msgtext4 = '<p class="image"><img src="img/whitebear.jpg" width="61px" height="61px"/></p><p class="text">WhiteBear Win!</p>';
const msgtext5 = '<p class="image"><img src="img/penguins.jpg" width="61px" height="61px"/><img src="img/whitebear.jpg" width="61px" height="61px"/></p><p class="text">Draw!</p>';
